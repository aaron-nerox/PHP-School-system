...
<body>
    <?php 
        ...
        $menu->create(2);
    ?>
    <center><p class="title">Découvrir le cycle primaire:</p></center>
    <div class="articles-container">
        <div class="info-card">
            ...
            <a href="./Details.php?info_mode=emploi&cycle=primaire">
        ...
        <div class="info-card">
            ...
            <a href="./Details.php?info_mode=ens&cycle=primaire">
                <button class="button-article">Afficher plus</button>
            </a>
        </div>
        <div class="info-card">
        ...
        <div class="info-card">
            ...
            <a href="./Details.php?info_mode=restau&cycle=primaire">
                <button class="button-article">Afficher plus</button>
            </a>
        </div>
    </div>
    <center><p class="title">Nos articles concernant le cycle primaire:</p></center>
    <?php   
        $articles = $articleController->getArticlesByScope(3);
